...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async AssembleGame(
        request: types.AssembleGameRequest,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.AssembleGameResponse> {
          try {
          ...
          const __stream__ = this.stream.AssembleGame(
          request,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.AssembleGameResponse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async PaidOnlineAssembly(
        request: types.PaidOnlineAssemblyRequest,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.PaidOnlineAssemblyResponse> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.PaidOnlineAssembly(
          request,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.PaidOnlineAssemblyResponse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            request: types.AssembleGameRequest,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.AssembleGameResponse, types.AssembleGameResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AssembleGame", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.AssembleGameResponse, types.AssembleGameResponse>(
                  __raw__,
                  (a): partial_types.AssembleGameResponse => a,
                  (a): types.AssembleGameResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            request: types.PaidOnlineAssemblyRequest,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.PaidOnlineAssemblyResponse, types.PaidOnlineAssemblyResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for PaidOnlineAssembly", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.PaidOnlineAssemblyResponse, types.PaidOnlineAssemblyResponse>(
                  __raw__,
                  (a): partial_types.PaidOnlineAssemblyResponse => a,
                  (a): types.PaidOnlineAssemblyResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
