import { z } from "zod";
import { AgeBandSchema, AssetContentTypeSchema, BuilderTemplateIdSchema, CapabilityTagSchema, GameTemplateAssetEditOperationSchema, GameTemplateAssetPromptKindSchema, GameTemplateAssetReplacementSourceSchema, GameTemplateLiveSurfaceComponentCapabilitiesSchema, GameTemplateLiveSurfaceKindSchema, GameTemplateTokenStyleSchema, InputModalitySchema, JsonValueSchema, PublicContractBaseSchema, StableIdSchema, VersionSchema } from "./base.js";
import { AssemblyValidationResultSchema, AssetGenerationRequestSchema, GeneratedAssetRecordSchema } from "./asset.js";
import { PlaycraftEventRecordSchema } from "./ag-ui.js";
...
export const MechanicBindingSchema = z.lazy(() => z
    .object({
    ...
    .strict());
export const RuleBindingSchema = z.lazy(() => z
    .object({
    bindingId: StableIdSchema,
    ...
    .strict());
export const ComponentBindingSchema = z.lazy(() => z
    .object({
    bindingId: StableIdSchema,
    ...
    .strict());
export const GameTemplateLiveSurfaceSchema = z.lazy(() => z
    .object({
...
export const GameTemplateDefinitionSchema = z.lazy(() => PublicContractBaseSchema.extend({
...
export const GameProfileTemplateSnapshotSchema = z.lazy(() => PublicContractBaseSchema.extend({
    id: BuilderTemplateIdSchema,
...
export const GameAssemblyProfileSchema = z.lazy(() => PublicContractBaseSchema.extend({
...
function liveSurfaceComponentCapabilities(capabilities) {
    return [capabilities.primary, capabilities.choice].filter((capability) => Boolean(capability));
}
function profileDuplicateStrings(values) {
    const seen = new Set();
...
function profileReplayEventSequencesAreAscending(eventLog) {
...
//# sourceMappingURL=game-template.js.map