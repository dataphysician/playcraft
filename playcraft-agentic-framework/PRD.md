...
| `BuilderToolDefinition` | Contract for reusable builder actions such as assemble, update, preview, catalog listing, session inspection, profile export, and profile import. |
