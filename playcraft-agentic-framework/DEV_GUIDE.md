...
| `packages/service` | Local app/API and `playcraft-service` CLI facade for text input, Moonshine Streaming CPU transcript records, template resolution, and asset edit levers. |
