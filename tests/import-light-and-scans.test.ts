...
describe("import-light boundaries and source scans", () => {
  ...
  it("keeps imported profile template selection tied to assembly request contracts", () => {
    ...
    expect(contractSource).toContain("profile validation snapshot id must match profile id");
    expect(contractSource).toContain("profile validation snapshot must be valid");
    expect(contractSource).toContain("profile validation snapshot must not contain errors");
  ...
  it("keeps service CLI stateful examples on exact request batches", () => {
    ...
    expect(contractSource).toContain("serviceActionRequiresSession");
    expect(contractSource).toContain("serviceActionAcceptsInput");
