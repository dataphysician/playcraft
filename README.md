...
Inputs are text and local Moonshine Streaming CPU transcript records. There is no hosted avatar stack, auth/database layer, generated runtime code, or real provider dependency in the framework path.
